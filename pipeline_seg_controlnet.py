...
if is_invisible_watermark_available():
    ...
    # from diffusers.stable_diffusion_xl.watermark import StableDiffusionXLWatermarker
...
class StableDiffusionXLSEGControlNetPipeline(
    DiffusionPipeline,
    ...
    def prepare_image(
        ...
        if do_classifier_free_guidance and not do_seg and not guess_mode:
            image = torch.cat([image] * 2)
        elif not do_classifier_free_guidance and do_seg and not guess_mode:
            image = torch.cat([image] * 2)
        elif do_classifier_free_guidance and do_seg and not guess_mode:
    ...
    def __call__(
        ...
        **kwargs,
        ...
        self.seg_applied_layers = seg_applied_layers
        self.seg_applied_layers_index = seg_applied_layers_index
